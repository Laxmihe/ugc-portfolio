  ...
  const videos = [
    {
      ...
      description:
        'High-converting short-form financial education video covering urgent borrowing alternatives and safer emergency funding options.',
      link: 'https://youtube.com/shorts/6vh37GYSt_0',
    },
    {
      title: 'Best Loan Apps Without Income Proof in 2026 (Get Approved Fast — No Salary Slip Needed)',
      description:
        'Authority-driven fintech explainer designed for users seeking approval-friendly emergency loan app solutions.',
      link: 'https://youtube.com/shorts/QEPRC97g-lA',
    },
    {
      title: 'Claude Cowork: Your Next Step - Get Started This Week [Complete Guide]',
      description:
        'Trust-building AI productivity walkthrough demonstrating software onboarding in a clear non-technical format.',
  ...
  const pillars = [
    {
      ...
      description:
        'A complete strategic guide to emergency borrowing, safe loan alternatives, and building a financial safety net.',
    ...
    },
    {
      ...
      description:
        'A deep-dive consumer education resource exposing predatory lending and helping borrowers make informed decisions.',
    ...
    },
    {
      ...
      description:
        'Long-form educational pillar content simplifying Claude Cowork for beginners and non-technical online professionals.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <img 
              ...
              alt="Laxmi Hegde - Professional Headshot" 
      ...
      <section id="about" className="py-16 px-6 max-w-5xl mx-auto">
        ...
        <p className="text-blue-100 text-lg leading-8 mb-8">
          ...
          I create high-authority educational content, fintech UGC videos, and SEO pillar resources
          that help audiences make smarter money decisions.
        </p>

        <div className="grid md:grid-cols-2 gap-8">
          <a href="https://confidencebuildings.com" target="_blank" rel="noopener noreferrer" className="group">
            <div className="bg-slate-900/50 border border-blue-400/20 rounded-xl overflow-hidden hover:border-blue-300/50 transition h-full">
              <img 
                src="/images/my website.png" 
                alt="Confidence Buildings - Financial Education Website" 
                className="w-full h-48 object-cover group-hover:opacity-80 transition"
              />
              <div className="p-6">
                <h3 className="text-lg font-bold text-blue-300 mb-2">My Website</h3>
                <p className="text-blue-200 text-sm">confidencebuildings.com - Financial education & resource hub</p>
              </div>
            </div>
          </a>

          <a href="https://www.tiktok.com/@laxminagaraj867?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="group">
            <div className="bg-slate-900/50 border border-cyan-400/20 rounded-xl overflow-hidden hover:border-cyan-300/50 transition h-full">
              <img 
                src="/images/tiktok profile.png" 
                alt="Laxmi TikTok Profile" 
                className="w-full h-48 object-cover group-hover:opacity-80 transition"
              />
              <div className="p-6">
                <h3 className="text-lg font-bold text-cyan-300 mb-2">TikTok</h3>
                <p className="text-cyan-200 text-sm">@laxminagaraj867 - Follow for financial tips & content</p>
              </div>
            </div>
          </a>
        </div>
            ...
            <div key={index} className="bg-slate-900/50 border border-blue-400/20 rounded-xl overflow-hidden hover:border-blue-300/50 transition">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-cyan-300 hover:text-cyan-100 font-semibold inline-flex items-center gap-2"
                >
      ...
      <section id="contact" className="py-20 px-6 max-w-3xl mx-auto">
        ...
        <div className="bg-slate-900/50 border border-blue-400/30 rounded-xl p-10 space-y-4">
          <a 
            href="mailto:laxmihegdeugc@proton.me" 
            className="flex items-center gap-4 p-4 bg-blue-500/10 rounded-lg hover:bg-blue-500/20 transition"
          >
            <Mail className="text-blue-400 w-6 h-6 flex-shrink-0" />
            <div>
          ...
          <a 
            href="https://linkedin.com/in/laxmihegde" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="flex items-center gap-4 p-4 bg-cyan-500/10 rounded-lg hover:bg-cyan-500/20 transition"
          >
            <span className="text-cyan-400 w-6 h-6 flex-shrink-0 text-xl">🔗</span>
            <div>
          ...
          <a 
            href="https://www.tiktok.com/@laxminagaraj867?is_from_webapp=1&sender_device=pc" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="flex items-center gap-4 p-4 bg-blue-500/10 rounded-lg hover:bg-blue-500/20 transition"
          >
            <span className="text-blue-400 w-6 h-6 flex-shrink-0 text-xl">🎵</span>
            <div>
          ...
          <a 
            href="https://confidencebuildings.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="flex items-center gap-4 p-4 bg-cyan-500/10 rounded-lg hover:bg-cyan-500/20 transition"
          >
            <BookOpen className="text-cyan-400 w-6 h-6 flex-shrink-0" />
            <div>
